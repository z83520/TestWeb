<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="TestBuy.Register" %>
...
<body>
  ...
  <div class="container">
      ...
      <div> </div>
      <asp:Button id="button1" runat="server" Text="確認" OnClick="button1_Click"> </asp:Button>
      <div> </div>
      <div> -------- 或 -------- </div>
